...
public class Search_channel {
  ...
  public static String startSearch() {
    ...
    try {
      InputStream in = Search_channel.class.getResourceAsStream("/" + PROPERTIES_FILENAME);
      properties.load(in);
...
//        prettyPrint(searchResultList.iterator(), queryTerm);
    	  rtnVal = getPretty(searchResultList.iterator(), queryTerm);
      }
  ...
  private static void prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query) {
    ...
    while (iteratorSearchResults.hasNext()) {
      ...
      if (rId.getKind().equals("youtube#video")) {
        ...
        System.out.println(" Video Url : https://youtu.be/" + rId.getVideoId());
  ...
  private static String getPretty(Iterator<SearchResult> iteratorSearchResults, String query) {
